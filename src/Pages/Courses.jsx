...
export default function Courses() {
  ...
  const courses = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=800&q=80&auto=format",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1559028012-481c04fa702d?w=800&q=80&auto=format",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1526379095098-d400fd0bf935?w=800&q=80&auto=format",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=800&q=80&auto=format",
  ...
  const courseFaqs = [
    {
      ...
      a: "We offer both self-paced modules and scheduled live cohorts. Check the course tags for specific mode details.",
    },
    {
      q: "Do I get a certificate upon completion?",
      a: "Yes, you will receive a verifiable industry-recognized certificate upon successfully passing the final project.",
    },
    {
      q: "What is the refund policy?",
      a: "We offer a 7-day money-back guarantee on all our self-paced courses. Live cohorts are refundable up to the 2nd session.",
    },
    {
      q: "Do I need prior experience?",
      a: "Beginner courses require no prior experience. Intermediate and Advanced courses have prerequisites listed on their detail pages.",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "The React course gave me exactly what I needed to transition from backend to full-stack. The capstone project was instrumental in my interview.",
      name: "Sarah Jenkins",
    ...
    {
      quote:
        "Practical, no-nonsense Python training. We built actual automation scripts that I use at work today.",
      name: "Michael Chen",
      role: "Data Analyst",
      projectImage:
    ...
    {
      quote:
        "The UI/UX design course completely changed how I approach my work. I created a full design system for my portfolio.",
      name: "Priya Patel",
    ...
    {
      quote:
        "Learned IoT from scratch. My final project was a smart home automation system that I actually installed in my house!",
      name: "James Wilson",
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(11, 20, 38, 0.75), rgba(11, 20, 38, 0.85)), url(/images/projenius-banner.webp)",
        }}
      >
        <div className="container title-section text-center h-100 d-flex flex-column justify-content-center">
          ...
          >
            Master in-demand skills with expert-led curriculum designed to
      ...
      <section className="modern-course-section section-padding py-5">
        <div className="container">
          ...
          {/* Sticky Filter Bar */}
          <div
            className="course-filter-bar mb-4 p-4 shadow-sm sticky-top"
            style={{
              backgroundColor: "#fff",
              borderRadius: "16px",
            ...
            {isLoading ? (
              Array.from({ length: 6 }).map((_, idx) => (
                <div className="col-lg-4 col-md-6" key={idx}>
                  <div
                    className="modern-course-card h-100 position-relative p-3"
                    style={{
                      border: "1px solid #e2e8f0",
                      borderRadius: "16px",
                    }}
              ...
              displayedCourses.map((course, index) => (
                ...
                >
                  <div
                    className="modern-course-card h-100 position-relative d-flex flex-column bg-white"
                    style={{
                      borderRadius: "16px",
                      border: "1px solid #e2e8f0",
                      overflow: "hidden",
                  ...
                  >
                    {course.badge && (
                      <div
                        ...
                        style={{
                          ...
                          right: "15px",
                          zIndex: 10,
                          backgroundColor: getBadgeColor(course.badge),
                          color: "#fff",
                          padding: "6px 12px",
                          borderRadius: "20px",
                          fontSize: "11px",
                    ...
                    <div
                      className="modern-course-image position-relative"
                      style={{
                        aspectRatio: "16/9",
                        overflow: "hidden",
                    ...
                    <div className="modern-course-content d-flex flex-column flex-grow-1 p-4">
                      <div className="d-flex justify-content-between align-items-start mb-2">
                        <span className="badge bg-primary bg-opacity-10 text-primary border border-primary-subtle rounded-pill px-3 py-2">
                          {course.category}
                        </span>
                      ...
                      <div
                        className="course-metadata mb-3 d-flex flex-wrap gap-3"
                        style={{
                          fontSize: "13px",
                          color: "#64748b",
                        }}
                      ...
                      <Link
                        to="/coursedetails"
                        state={{ course }}
                        className="btn btn-primary w-100 course-cta-btn py-2 fw-semibold d-flex justify-content-center align-items-center"
                        style={{
                          borderRadius: "8px",
                          transition: "all 0.2s",
                        }}
      ...
      >
        <div className="container">
          ...
          {/* STUDENT SUCCESS HEADING */}
          <div className="student-success-heading text-center mb-5">

            <div className="student-success-label">
              <span className="student-success-dot"></span>
            ...
            {/* CENTERED LINE */}
            <div className="student-success-line"></div>
          ...
          <div className="row justify-content-center g-4">
            {testimonials.map((t, idx) => (
              <div className="col-lg-6 col-md-12" key={idx}>
                <div
                  className="card border-0 shadow-sm h-100 p-0 overflow-hidden bg-white"
                  ...
                  <div className="row g-0 h-100">
                    ...
                    <div className="col-sm-5 position-relative">
                      ...
                      <div className="position-absolute top-0 end-0 p-2">
                        <a
                          href={t.projectLink}
                          className="btn btn-sm btn-light rounded-pill shadow-sm py-1 px-3 d-flex align-items-center"
                          style={{
                            fontSize: "12px",
                            fontWeight: "600",
                          }}
                        >
                          <i className="bi bi-link-45deg me-1 fs-6"></i>
                          View Project
                        </a>
                      </div>
                    </div>
      ...
      <section className="faq-grid-section py-5">
        <div className="container">
          ...
          <div className="text-center mb-4">
            <h2 className="faq-grid-title">
              Looking for Answers?
            </h2>

            <p
              className="faq-grid-subtitle mx-auto"
              style={{ maxWidth: "700px" }}
            >
              Before sending a message or enrolling, please check our
              comprehensive FAQ section regarding courses. You might find the
              solution instantly!
            </p>
      ...
      >
        <div className="container text-center py-4">
          ...
          >
            Stop guessing. Book a 1-on-1 mentorship call with our industry
            experts to get a personalized career roadmap before you enroll.
          </p>
