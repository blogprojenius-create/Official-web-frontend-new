...
export default function CareerGuidance() {
  ...
  // Generate 4 consecutive dates: today + next 3 days.
  useEffect(() => {
    const dates = [];
  ...
  // Re-check the current time every 30 seconds so passed slots
  // become disabled automatically without refreshing the page.
  useEffect(() => {
  ...
  // Keep the selected time valid when the date/current time changes.
  // If the user has already selected a valid future slot, do not overwrite it.
  useEffect(() => {
    ...
    const currentSelectionIsValid =
      selectedTime && !isSlotDisabled(selectedTime);
  ...
  const handleBookingClick = (e) => {
    ...
    navigate("/book-call", {
      state: {
        date: selectedDateObject?.fullDate || selectedDate,
        time: selectedTime,
              ...
              <div className="bc-widget-mockup shadow-lg" style={{ borderRadius: '24px', backgroundColor: '#fff', border: '1px solid #e2e8f0', padding: '0', display: 'flex', flexDirection: 'column' }}>
                ...
                <div className="bc-mockup-body text-center" style={{ padding: '32px 32px 40px' }}>
                  ...
                  <div className="bc-mockup-calendar">
                    ...
                    <div className="bc-cal-row dates">
                      {availableDates.map((d) => (
                        <span
                          key={d.dateKey}
                          className={selectedDate === d.dateKey ? "active" : ""}
                          style={
                  ...
                  <div className="bc-mockup-times mt-4 mb-4">
                    ...
                    {["10:00 AM", "2:30 PM", "4:00 PM", "6:00 PM"].map((time) => {
                      ...
                      return (
                        <span
                          key={time}
                          className={`bc-time ${active ? "active" : ""} ${disabled ? "disabled-slot" : ""}`}
                          style={{
                  ...
                  <button
                    ...
                    className="btn btn-primary-custom btn-lg w-100 shadow-sm"
                    style={{
                      backgroundColor: "#0ea5e9",
                      borderColor: "#0ea5e9",
                    }}
