...
import { Atom, ChartNoAxesCombined, Code2, Coffee, Cpu, LayoutPanelTop, Network, Palette, Router, Server, Smartphone, Terminal } from "lucide-react";
import "../index.css";
  ...
  return (
    <>
            ...
            >
              ...
              <div className="modern-cta-group">
                ...
                <a href="#brochure" className="modern-btn-secondary">
                  ...
                  <i className="bi bi-cloud-arrow-down" aria-hidden="true"></i>
                </a>
              </div>
            </motion.div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="card-content-relative">
                      <div className={`card-icon-wrapper ${index === 0 ? "color-blue" :
        ...
        <div className="container">
          ...
          >
            ...
            <p className="internship-domains-lead">
              Select a domain to preview the learning outcome, then apply directly for your preferred track.
            </p>
          </motion.div>

          <div className="internship-filter-row" role="tablist" aria-label="Internship domain filters">
          ...
          <div className="track-explorer-meta" aria-label="Internship program overview">
            <span><i className="bi bi-grid-1x2" aria-hidden="true"></i> {visibleDomains.length} tracks available</span>
            <span><i className="bi bi-kanban" aria-hidden="true"></i> Project-based learning</span>
            <span><i className="bi bi-calendar-check" aria-hidden="true"></i> New cohorts now open</span>
          </div>
          ...
          <div className="internship-domain-layout">
            <div className="internship-domain-grid" role="list">
              {visibleDomains.map((domain, index) => {
                ...
                return <motion.button
                  className={`internship-domain-card ${selectedDomain.title === domain.title ? "active" : ""}`}
                  key={domain.title}
                  type="button"
                  role="listitem"
                ...
                >
                  <div className="domain-card-top">
                    <div className="domain-icon-shell">
                      <DomainIcon aria-hidden="true" strokeWidth={2} />
                    </div>
                    <span className="domain-category-tag">{domain.category}</span>
                  </div>
                  <div className="domain-card-copy">
                    <h3>{domain.title}</h3>
                    <span className="domain-card-caption">Career-focused internship</span>
                  </div>
                  <span className="internship-domain-apply">
                    View Track <i className="bi bi-arrow-right-short" aria-hidden="true"></i>
                  </span>
                </motion.button>;
              })}
            </div>
            ...
            >
              <div className="track-preview-header">
                <span className="track-preview-label">Selected Track</span>
                <span className="track-preview-status"><i className="bi bi-check2-circle" aria-hidden="true"></i> Open</span>
              </div>
              <div className="track-preview-identity">
                <div className="track-preview-icon-shell">
                  <SelectedDomainIcon aria-hidden="true" strokeWidth={2} />
                </div>
                <span className="track-preview-category">{selectedDomain.category}</span>
              </div>
              <h3>{selectedDomain.title}</h3>
              <p>{selectedDomain.outcome}</p>
              <div className="track-preview-facts" aria-label="Program details">
                <span><i className="bi bi-calendar3" aria-hidden="true"></i> Flexible duration</span>
                <span><i className="bi bi-person-workspace" aria-hidden="true"></i> Mentor-led projects</span>
              </div>
              <div className="track-preview-note">
                <i className="bi bi-shield-check" aria-hidden="true"></i>
                <span>Certificate and portfolio review included</span>
              </div>
              <a
      ...
      <section className="internship-capabilities-section">
        <div className="container">
          <div className="section-heading text-center">
            <span id="sub-heading">Program Highlights</span>
            <h2 id="title">What Makes This Internship Different</h2>
          </div>
          ...
          <div className="capabilities-layout">
            ...
            >
              <div className="cap-panel-label">What Interns Will Learn</div>
              <h3>Work Like a<br />Modern Tech Team</h3>
              <p className="cap-panel-desc">Master industry-standard tools, workflows, and collaboration practices used by professional development teams.</p>
              <div className="cap-panel-list">
                {learningPoints.map((point, index) => (
                  <div className="cap-list-item" key={point.text}>
                    <span className="cap-item-num">{String(index + 1).padStart(2, '0')}</span>
            ...
            >
              <div className="cap-panel-label cap-label-blue">Benefits</div>
              <h3>Career Support<br />Beyond Training</h3>
              <div className="cap-benefits-grid">
                {benefits.map((benefit) => (
                  ...
                  >
                    <div className={`cap-benefit-icon color-${benefit.color}`}>
      ...
      <section className="internship-metrics-section">
        <div className="container">
          ...
          <div className="metrics-strip" ref={statsRef}>
            {stats.map((stat, index) => (
              ...
              >
                <div className={`metric-icon color-${stat.color}`}>
          ...
          <div className="success-proof-row">
            {successStories.map((story) => (
              <div className="success-proof-item" key={story.text}>
