...
const FALLBACK_REVIEWS = [
  ...
  },
  {
    ...
    name: "Aruna Sree N",
    role: "Client",
    review: "\u201cI had a very positive experience with ProJenius. The project was delivered on time with great attention to detail. The team was highly professional, responsive, and ensured everything was handled efficiently.\u201d",
    color: "#0f766e"
  },
  {
    id: 12,
      ...
      <div className="container">
        ...
        <div className="testi-header" data-aos="fade-up">
          ...
          <h2 className="testi-title">
            What Our <span className="testi-title-accent">Clients Say</span>
          </h2>
        ...
        {/* Carousel */}
        <div className="testi-carousel-wrap" data-aos="fade-up" data-aos-delay="150">
          <Swiper
                ...
                <div className="testi-card">
                  ...
                  <div className="testi-card-left">
                    ...
                    <div className="testi-google-badge">
                      <span className="testi-google-text">Google</span>
                    ...
                    {/* Review Text */}
                    <p className="testi-review-text">{review.review}</p>
                    ...
                    <div className="testi-client">
                      <div className="testi-client-avatar" style={{ background: review.color }}>
                        <span>{review.name.charAt(0).toUpperCase()}</span>
                      </div>
                      <div className="testi-client-info">
                        <h4 className="testi-client-name">{review.name}</h4>
                  ...
                  <div className="testi-card-right">
                    {/* Decorative circle */}
                    <div className="testi-deco-circle" style={{ background: `${review.color}18` }}>
                      <div className="testi-deco-circle-inner" style={{ background: `${review.color}25`, borderColor: `${review.color}30` }}></div>
                    </div>
                    ...
                    <div className="testi-quote-mark">
                      <svg width="64" height="64" viewBox="0 0 24 24" fill="none">
                        <path d="M3 21c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2H4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1z" fill="#0f172a"/>
                        <path d="M15 21c3 0 7-1 7-8V5c0-1.25-.757-2.017-2-2h-4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2h.75c0 2.25.25 4-2.75 4v3c0 1 0 1 1 1z" fill="#0f172a"/>
                      </svg>
                    </div>
                  </div>
          ...
          {/* Navigation Arrows */}
          <button ref={prevRef} className="testi-nav-btn testi-nav-prev" aria-label="Previous testimonial">
            <ChevronLeft size={22} strokeWidth={2.5} />
          </button>
          <button ref={nextRef} className="testi-nav-btn testi-nav-next" aria-label="Next testimonial">
