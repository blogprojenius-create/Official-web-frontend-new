...
const MOBILE_PAGE_HEIGHT =
  Math.round(MOBILE_PAGE_WIDTH * 1.414);

/* ─────────────────────────────────────────────
   Render only nearby pages
───────────────────────────────────────────── */

const MagazinePageItem = forwardRef(
  ({ pageNumber, activePage, width, height }, ref) => {
    const shouldRender =
      Math.abs(pageNumber - (activePage + 1)) <= 3;
    ...
    <section className="magazine-sec-main-wrapper">
      ...
      <div className="magazine-viewer-container">
        ...
        <div className="magazine-copy-col">
          ...
          {/* Main heading */}
          <h2
            className="section-title mag-heading"
            id="title"
          >
            Explore the{" "}
          ...
          <p className="section-desc mag-desc">
            See our services, training work,
            project approach, and company story
